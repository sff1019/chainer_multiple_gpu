...
# class ParallelMLP(chainer.Chain):
#     def __init__(self, n_units, n_out, gpu0, gpu1k gpu2, gpu3):
#         self.gpu0 = gpu0
#         self.gpu1 = gpu1
#         self.gpu2 = gpu2
#         self.gpu3 = gpu3
...
#         super(ParallelMLP, self).__init__()
#         with self.init_scope():
#             self.mlp1_gpu0 = MLP(n_units // 4, n_units).to_gpu(self.gpu0)
#             self.mlp1_gpu1 = MLP(n_units // 4, n_units).to_gpu(self.gpu1)
#             self.mlp1_gpu2 = MLP(n_units // 4, n_units).to_gpu(self.gpu2)
#             self.mlp1_gpu3 = MLP(n_units // 4, n_units).to_gpu(self.gpu3)
#
#             self.mlp2_gpu0 = MLP(n_units // 4, n_units).to_gpu(self.gpu0)
#             self.mlp2_gpu1 = MLP(n_units // 4, n_units).to_gpu(self.gpu1)
#             self.mlp2_gpu2 = MLP(n_units // 4, n_units).to_gpu(self.gpu2)
#             self.mlp2_gpu3 = MLP(n_units // 4, n_units).to_gpu(self.gpu3)
#
#     def forward(self, x):
#         z0 = self.mlp1_gpu0(x)
#         z1 = self.mlp1_gpu1(F.copy(x, self.gpu1))
